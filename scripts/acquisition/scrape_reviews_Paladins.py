...
BASE_URL = "https://store.steampowered.com/appreviews/444090?json=1"  # Replace 12345 with the relevant App ID
max_pages = 10
...
if scraped_reviews:
    ...
    reviews_df.to_csv("data/raw/raw_reviews_Paladins.csv", index=False)
